...
export const EtherProvider = ({ children }) => {
  ...
  const networksData = () => {
    axios
      .get("https://tokenmaker-apis.block-brew.com/network/fullnetwork")
      .then((res) => {
  ...
  const urlLinks = {
    ...
    256: {
      ...
      name: "Heco TestNetwork Scan",
      networkName: "Heco Testnet",
      symbol: "HT",
      rpc: "https://http-testnet.hecochain.com",
    },
    128: {
      link: "https://scan.hecochain.com",
      name: "Heco Mainnet Scan",
    ...
    10: {
      ...
      name: "Optimism Mainnet Scan",
      networkName: "Optimism Mainnet",
      symbol: "Ether",
      rpc: "https://mainnet.optimism.io",
    },
    420: {
      link: "https://goerli-explorer.optimism.io",
      name: "Optimism Goerli Scan",
    ...
    4689: {
      link: "https://iotexscan.io",
      name: "IoTeX Mainnet Scan",
      networkName: "Iotex Mainnet",
      symbol: "IOTX",
      rpc: "https://babel-api.mainnet.iotex.io",
    },
    4690: {
      link: "https://testnet.iotexscan.io/",
      name: "IoTeX Testnet Scan",
      networkName: "Iotex Testnet",
      symbol: "IOTX",
    ...
    122: {
      ...
      name: "Fuse Mainnet Scan",
      networkName: "Fuse Mainnet",
      symbol: "FUSE",
      rpc: "https://rpc.fuse.io",
    },
    123: {
      link: "https://docs.fuse.io/general/fuse-network-blockchain/fuse-testnet",
      name: "Fuse Sparknet Scan",
      networkName: "Fuse Sparknet",
      symbol: "SPARK",
      rpc: "https://rpc.fusespark.io",
    },
    10000: {
      link: "https://smartbch.org/",
      name: "Smart Bitcoin Cash Scan",
      networkName: "Smart Bitcoin Cash",
      symbol: "BCH",
      rpc: "https://smartbch.greyh.at",
    },
    10001: {
      link: "https://smartbch.org/",
      name: "Bitcoin Cash Test Token Scan",
      networkName: "Bitcoin Cash Test Token",
      symbol: "BCHT",
