...
const HeroSkeleton = () => {
  ...
  return (
    <div className="heroskeleton">
      ...
      <section className="timeline" id="timeline">
        <div className="container text-center">
          <div className="timeline_wrap text-center">
            <h2 className="section-title mt-4" style={{ maxWidth: "700px" }}>
              <Skeleton
                variant="rounded"
                height={16}
                width={500}
                    ...
                    <>
                      <div
                        className={`col-lg-10 offset-lg-1 ${
                          i === stepsData.length - 1 ? "" : "timeline_right"
                        } timeline_main`}
                        key={data.id}
                      >
                        <div className="row justify-content-center align-items-center">
      ...
      <section className="page-section  my-4 py-5">
        <div className="container">
          <h2 className="section-title-small text-center d-flex justify-content-center">
      ...
      <section className="page-section p-4 p-md-5 mt-5">
        <div className="container">
          <h2 className="section-title-small text-center d-flex justify-content-center">
            <Skeleton variant="rounded" height={20} width={655} />
          </h2>
