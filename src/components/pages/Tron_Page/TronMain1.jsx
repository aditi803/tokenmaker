...
const TronMain1 = (props) => {
  ...
  const { deployTron,deployContract, changeNetwork,addNewNetwork, connectedAccAddress, SignInMetamask, blockchainNetworks, sendCommision } =
  ...
  useEffect(() => {
    ...
    const selectedCommissionFee = data?.find(({ value, parentNetworkName, subNetworkName, tokenType }) => {
      if (parentNetworkName === 'IoTeX' && (value === ethFormData.network || value === customVampire(ethFormData.network)) && tokenType === ethFormData.tokenType) {
        return true;
      }
    })
      ...
      if (res) {
        ...
        axios
          ...
          .then((res) => {
            ...
            deployTron(res.data.result, FormData).then((res) => {
        ...
        <main>
          <div className="hero mb-5">
            <div className="container">
              <h1>
                <span className="sub-highlight">Create Your IoTeX Token</span>
              </h1>
              <p>
                Easily deploy your Smart Contract for a Standard, Capped,
                Mintable, Burnable IoTeX Token.
                <br />
                          ...
                          <div className="form-group">
                            ...
                            >
                              <option value='none' selected hidden>Select your network</option>
                               ...
                               <option value="  " >IoTeX Mainnet</option>
                               <option value="IoTeXTestnet" >IoTeX Testnet</option>
                              {/* {data.map((item, i) => {
