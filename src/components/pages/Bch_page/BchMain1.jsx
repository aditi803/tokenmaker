...
const BchMain1 = (props) => {
  ...
  useEffect(() => {
    ...
    const selectedCommissionFee = data?.find(({ value, parentNetworkName, subNetworkName, tokenType }) => {
      if (parentNetworkName === 'Bch' && (value === ethFormData.network || value === customVampire(ethFormData.network)) && tokenType === ethFormData.tokenType) {
        return true;
      }
    })
        ...
        <main>
          <div className="hero mb-5">
            <div className="container">
              <h1>
                <span className="sub-highlight">Create Your Bch Token</span>
              </h1>
              <p>
                Easily deploy your Smart Contract for a Standard, Capped,
                Mintable, Burnable Bch Token.
                <br />
                          ...
                          <div className="form-group">
                            ...
                            >
                              <option value='none' selected hidden>Select your network</option>
                               ...
                               <option value="BchMainnet" >Bch Mainnet</option>
                               <option value="BchTestnet" >Bch Testnet</option>
                              {/* {data.map((item, i) => {
